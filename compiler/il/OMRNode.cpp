...
OMR::Node::getMonitorClassInNode()
   ...
   return info == (TR_OpaqueClassBlock *) MONITOR_IDENTITY_CLASS_PLACEHOLDER ? NULL: info;
#endif
   }
...
OMR::Node::isMonitorIdentityType()
   ...
   if (!self()->hasMonitorInfoInNode())
      return TR_maybe;
   if (self()->getMonitorInfoInNode() == (void *) MONITOR_IDENTITY_CLASS_PLACEHOLDER)
      return TR_yes;
...
OMR::Node::setMonitorIdentityType()
   ...
   if (self()->hasMonitorInfoInNode())
      return;
   self()->setMonitorInfoInNode((void *) MONITOR_IDENTITY_CLASS_PLACEHOLDER);
   self()->setHasMonitorInfoInNode(true);
   }
