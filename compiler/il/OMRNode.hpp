...
#define MONITOR_IDENTITY_CLASS_PLACEHOLDER -1
...
public:
    ...
    * 2. MONITOR_IDENTITY_CLASS_PLACEHOLDER is stored if the exact monitor type is unknown but is of
    *    Identity class type
    */
   ...
   /*
    * \parm info
    *    info can be either a persistent class identifier or MONITOR_IDENTITY_CLASS_PLACEHOLDER
    */
